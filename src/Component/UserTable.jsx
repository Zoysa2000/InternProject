                ...
                {[
                    ...
                    <tr key={i} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        <td className="w-4 p-4">
                            <input type="checkbox" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded-sm focus:ring-blue-500 dark:focus:ring-blue-600 dark:bg-gray-700 dark:border-gray-600" />
                        </td>
                        <th scope="row" className="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white">{emp.name}</th>
                        <td className="px-6 py-4">{emp.id}</td>
                        <td className="px-6 py-4">{emp.dept}</td>
                        <td className="px-6 py-4">{emp.detail}</td>
                        <td className="px-6 py-4">
                            <button style={{ backgroundColor: "#16056B" }} className="text-white font-medium rounded-md text-sm px-4 py-1.5 transition">
                                View
                            </button>
                        </td>
                    </tr>
