...
const ModeBtn = () => {
    ...
    return (
        <div className="fixed top-4 right-4 z-50">
            <label className="themeSwitcherTwo shadow-card relative inline-flex cursor-pointer select-none items-center justify-center rounded-md bg-white p-1 dark:bg-gray-800">
                <input
                    type="checkbox"
                    className="sr-only"
                    checked={isChecked}
